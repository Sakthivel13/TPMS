...
class InputValidatorApp(QMainWindow):
    ...
    def __init__(self):
        ...
        log_folder = r"D:\Python\TVS NIRIX V1.3\test_results"
        try:
        ...
        self.setMinimumSize(720, 1250)  # Minimum size to ensure readability

        central_widget = QWidget()
        self.setCentralWidget(central_widget)
        main_layout = QVBoxLayout(central_widget)

        # Layout for VIN input
        vin_row_layout = QHBoxLayout()
        self.vin_label = QLabel("Enter VIN:")
        self.vin_label.setStyleSheet("font-size: 25px; font-weight: bold;")
        self.vin_input = QLineEdit()
        self.vin_input.setMaxLength(17)
        self.vin_input.setPlaceholderText("Eg :MD612325678912325")
        self.vin_input.setStyleSheet("font-size: 20px; padding: 5px;")
        self.vin_input.setFixedWidth(500)
        ...
        # Layout for API selection
        api_row_layout = QHBoxLayout()
        self.select_api_label = QLabel("Select API:")
        self.select_api_label.setStyleSheet("font-size: 25px; font-weight: normal; padding-left: 25px;")
        self.radio_prd = QRadioButton("PRD")
        self.radio_prd.setChecked(True)
        self.radio_prd.setStyleSheet("font-size: 20px; font-weight: normal; padding-left: 50px;")
        self.radio_ejo = QRadioButton("EJO")
        self.radio_ejo.setStyleSheet("font-size: 20px; font-weight: normal; padding-right: 25px;")
        ...
        api_row_layout.addWidget(self.select_api_label)
        api_row_layout.addWidget(self.radio_prd)
        api_row_layout.addWidget(self.radio_ejo)
        api_row_layout.addStretch()

        main_layout.addLayout(api_row_layout)

        self.active_library_label = QLabel(f"Active Library: {self.active_library}")
        self.active_library_label.setStyleSheet("font-size: 25px; font-weight: normal;")
        ...
        self.instructions_label.setStyleSheet("font-size: 25px; font-weight: bold; border: 1px solid black; padding: 8px;")
        self.instructions_label.setAlignment(Qt.AlignTop)
        bottom_layout.addWidget(self.instructions_label, stretch=1)

        self.result_label = QLabel("Result:")
        self.result_label.setStyleSheet("font-size: 25px; font-weight: bold; border: 1px solid black; padding: 8px;")
    ...
    def run_next_test(self):
        if self.current_test_index < len(self.test_cases):
            ...
            self.result_label.setText(
                f'Result:<br> <span style="color:{color}; font-weight:bold; font-size:25px;">{function} - {status}</span>'
            )
            ...
            if not result:
                ...
                self.result_label.setText(
                    f'Result:<br> <span style="color:red; font-weight:bold; font-size:25px;">{function} - FAILED</span>'
                )
            ...
            self.result_label.setText(
                f'Result:<br> <span style="color:green; font-weight:bold; font-size:25px;">All tests passed successfully!</span>'
            )
            self.instructions_label.setText(
